...
@section('content')
  ...
  <h4 class="text-center">This event listing is provided in partnership with the Charleston Convention and Visitors Bureau. </h4>  
    ...
    <script defer type="text/javascript"
        src="https://google.com?schools=charlestonwv&exclude_groups=city_of_charleston&days=60&num=50&target_blank=1&experience=inperson&container=localist-widget-57991154&template=modern">
    </script>
